  ...
  return (
    ...
    >
      <Toolbar sx={{ height: layout.navbarHeight, minHeight: layout.navbarHeight, px: { xs: 1.5, md: 2.5 }, gap: 1.5 }}>
        ...
        <Box sx={{ minWidth: 0 }}>
          <Typography sx={{ fontSize: '0.625rem', fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', color: colors.textMuted, lineHeight: 1.2 }}>
            Book Management
          </Typography>
          <Typography sx={{ fontSize: '0.9375rem', fontWeight: 600, letterSpacing: '-0.008em', lineHeight: 1.25 }} noWrap>
            {pageTitle}
          </Typography>
        </Box>
        ...
        >
          <Avatar sx={{ width: 30, height: 30, fontSize: '0.75rem', fontWeight: 600, bgcolor: colors.primary }}>
            {initial}
          </Avatar>
